...
.method constructor <init>(Ljava/util/Map;)V
    ...
    iput-object v3, p0, Landroid/arch/lifecycle/ClassesInfoCache$CallbackInfo;->mEventToHandlers:Ljava/util/Map;
    ...
    .line 172
    .local v0, "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Landroid/arch/lifecycle/ClassesInfoCache$MethodReference;Landroid/arch/lifecycle/Lifecycle$Event;>;"
    ...
    .line 174
    .local v2, "methodReferences":Ljava/util/List;, "Ljava/util/List<Landroid/arch/lifecycle/ClassesInfoCache$MethodReference;>;"
    if-nez v2, :cond_0

    .line 175
    new-instance v2, Ljava/util/ArrayList;

    .end local v2    # "methodReferences":Ljava/util/List;, "Ljava/util/List<Landroid/arch/lifecycle/ClassesInfoCache$MethodReference;>;"
    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    .line 176
    .restart local v2    # "methodReferences":Ljava/util/List;, "Ljava/util/List<Landroid/arch/lifecycle/ClassesInfoCache$MethodReference;>;"
    iget-object v4, p0, Landroid/arch/lifecycle/ClassesInfoCache$CallbackInfo;->mEventToHandlers:Ljava/util/Map;
    ...
    .line 180
    .end local v0    # "entry":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Landroid/arch/lifecycle/ClassesInfoCache$MethodReference;Landroid/arch/lifecycle/Lifecycle$Event;>;"
